...
%>
  <head>
	...
	<script src="js/techtypemanage.js" type="text/javascript"></script>
  ...
  <a class="brand" href="#"><img src="images/logo_water.jpg" width="100" height="50" alt="Water Res">&nbsp;<span class="first">WaterRes</span> </a>
    ...
    <div class="content">
         <div class="header">
           <h1 class="page-title">工艺类别体系管理</h1>
        </div>
        
        <ul class="breadcrumb">
            <li>工艺类别体系管理<span class="divider">/</span></li>
            <li><a href="typeMgt.jsp">工艺类别管理</a><span class="divider">/</span></li>
        </ul>
        <div class="container-fluid">
        <div class="row-fluid">
       <div class="span12">

					  <form  action="<%=basePath%>typenagement/addtechTypeAction"  method="post">
						<label>对应污染物类别</label>
						<select id="zhtype" name="zhtype"></select>
						<label>上级工艺类别</label>
						<select id="techtype" name="techtype"></select>
						<label>名称</label>
						<input type="text" id="techName" name="techName" /><label id="tiptravel" style=" color:red"></label>
						<label>备注</label>
						<textarea id="techMemo" name="techMemo"></textarea>
						<br /> 
