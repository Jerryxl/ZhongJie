...
function initDatatable(){
		...
		"aoColumns": [   
			...
			"fnRender":function(obj, value){
				var sReturn;
				sReturn = '<a href="#.html"><i class="icon-unlock"></i></a>&nbsp;<a href="#.html"><i class="icon-lock"></i></a>&nbsp;<a href="#" onClick="deleteLine()"><i class="icon-remove"></i></a>';
				return sReturn;}
				}
         ]
		});
